...
export const AdminShow = () => {
    ...
    return (
        <Show
            title={<Title level={3}>Chi tiết Quản trị viên</Title>}
            breadcrumb={
                    ...
                    >
                        ...
                        <Row gutter={[16, 16]}>
                            <Col xs={24} sm={12} md={8}>
                                ...
                                <TextField
                                    value={record?.name || "Không có tên"}
                            ...
                            <Col xs={24} sm={12} md={8}>
                                ...
                                <TextField
                                    value={record?.email || "Không có email"}
                                    style={{ fontSize: 16, color: "#000" }}
                                />
                            </Col>
                            <Col xs={24} sm={12} md={8}>
                        ...
                        <Row gutter={[16, 16]}>
                            <Col xs={24} sm={12} md={8}>
                                ...
                                <Tag
                                    color={record?.role === "admin" ? "blue" : "default"}
                                    style={{ fontSize: 14, padding: "4px 8px" }}
                                >
                                    {record?.role === "admin" ? "Quản trị viên" : "Không xác định"}
                                </Tag>
                            </Col>
                            <Col xs={24} sm={12} md={8}>
                                <Title level={5} style={{ marginBottom: 8, color: "#595959" }}>
